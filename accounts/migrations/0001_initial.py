    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.IntegerField(help_text='+989')),
                ('city', models.CharField(max_length=30)),
                ('province', models.CharField(blank=True, max_length=30, null=True)),
                ('role', models.CharField(choices=[('User', 'User'), ('Empolyee', 'Employee'), ('Admin', 'Admin'), ('Manager', 'Manager'), ('Others', 'Others')], default='User', max_length=20)),
                ('national_id', models.IntegerField(help_text='2580945710')),
